...
packetloom is a C project for networking. It focuses on this technical goal: Parse Ethernet, IPv4, and UDP packet fixtures with bounds checks.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 160, risk penalty 7, latency penalty 3, and weight bonus 6. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
