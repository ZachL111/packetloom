...
`packetloom` is centered on networking work in C. The technical target is: Parse Ethernet, IPv4, and UDP packet fixtures with bounds checks.
...
The score is deterministic. The current threshold is 160. Risk has a penalty of 7, latency has a penalty of 3, and weight contributes a bonus of 6.
