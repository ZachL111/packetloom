"""Regression checks for the packetloom casebook."""
...
from casebook.harness import assert_expected, packetloom_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(packetloom_summary(), assert_expected())
